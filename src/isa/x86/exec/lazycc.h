...
#ifdef LAZY_CC
static inline void rtl_set_lazycc_dest(DecodeExecState *s, const rtlreg_t *dest) {
  rtl_mv(s, &cpu.cc_dest, dest);
}

static inline void rtl_set_lazycc_src1(DecodeExecState *s, const rtlreg_t *src1) {
  rtl_mv(s, &cpu.cc_src1, src1);
}

static inline void rtl_set_lazycc_src2(DecodeExecState *s, const rtlreg_t *src2) {
  rtl_mv(s, &cpu.cc_src2, src2);
}

static inline void rtl_set_lazycc(DecodeExecState *s, const rtlreg_t *dest, const rtlreg_t *src1, const rtlreg_t *src2,
...
static inline void rtl_lazy_jcc(DecodeExecState *s, uint32_t cc) {
...
static inline void rtl_lazy_setcc(DecodeExecState *s, rtlreg_t *dest, uint32_t cc) {
  int exception = (cpu.cc_op == LAZYCC_SUB) && (cc == CC_E || cc == CC_NE);
  if ((cc2relop[cc] & UNARY) && !exception) {
    uint32_t relop = cc2relop[cc] ^ UNARY;
    rtlreg_t *p = &cpu.cc_dest;
